...
<!-- Twitter social link -->
<Story args={{ description: "Twitter profile link", link: "#" }} name="Twitter social link" >
	<svg class="w-[14rem] h-[16rem] object-contain" viewBox="0 0 640 640" xmlns="http://www.w3.org/2000/svg">
...
<Story args={{ description: "Instagram profile link", link: "#" }} name="Instagram social link" >
	<svg class="w-[13rem] h-[16rem] object-contain" viewBox="0 0 640 640" xmlns="http://www.w3.org/2000/svg">
...
<Story args={{ description: "Facebook profile link", link: "#" }} name="Facebook social link" >
	<svg class="w-[9rem] h-[16rem] object-contain" viewBox="0 0 640 640" xmlns="http://www.w3.org/2000/svg">
