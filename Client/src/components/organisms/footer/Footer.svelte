	...
	<SocialLinks>
		...
		<SocialLinkItem>
			<SocialLink description="Link to Twitter profile" url="#">
				<svg class="w-[20rem] h-[24rem] object-contain" viewBox="0 0 640 640" xmlns="http://www.w3.org/2000/svg">
		...
		<SocialLinkItem>
			<SocialLink description="Link to Instagram profile" url="#">
				<svg class="w-[20rem] h-[26rem] object-contain" viewBox="0 0 640 640" xmlns="http://www.w3.org/2000/svg">
