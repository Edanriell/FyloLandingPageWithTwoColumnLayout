...
<footer {...restProps} class="footer bg-[#070439] flex flex-col items-start desktop:flex-row desktop:items-between desktop:justify-between {classes}">
	...
	<SocialLinks classes="self-start desktop:mt-[77rem]!">
		<SocialLinkItem>
			<SocialLink description="Link to Facebook profile" url="#">
				<svg class="w-[14rem] h-[26rem] desktop:w-[18rem] desktop:h-[32rem] object-contain" viewBox="0 0 640 640" xmlns="http://www.w3.org/2000/svg">
		...
		<SocialLinkItem>
			<SocialLink description="Link to Twitter profile" url="#">
				<svg class="w-[17rem] h-[17rem] desktop:w-[20rem] desktop:h-[20rem] object-contain" viewBox="0 0 640 640" xmlns="http://www.w3.org/2000/svg">
					<path d="M523.4 215.7C523.7 220.2 523.7 224.8 523.7 229.3C523.7 368 418.1 527.9 225.1 527.9C165.6 527.9 110.4 510.7 64 480.8C72.4 481.8 80.6 482.1 89.3 482.1C138.4 482.1 183.5 465.5 219.6 437.3C173.5 436.3 134.8 406.1 121.5 364.5C128 365.5 134.5 366.1 141.3 366.1C150.7 366.1 160.1 364.8 168.9 362.5C120.8 352.8 84.8 310.5 84.8 259.5L84.8 258.2C98.8 266 115 270.9 132.2 271.5C103.9 252.7 85.4 220.5 85.4 184.1C85.4 164.6 90.6 146.7 99.7 131.1C151.4 194.8 229 236.4 316.1 240.9C314.5 233.1 313.5 225 313.5 216.9C313.5 159.1 360.3 112 418.4 112C448.6 112 475.9 124.7 495.1 145.1C518.8 140.6 541.6 131.8 561.7 119.8C553.9 144.2 537.3 164.6 515.6 177.6C536.7 175.3 557.2 169.5 576 161.4C561.7 182.2 543.8 200.7 523.4 215.7z" fill="currentColor"/>
				</svg>
			</SocialLink>
		</SocialLinkItem>
		<SocialLinkItem>
			<SocialLink description="Link to Instagram profile" url="#">
				<svg class="w-[19rem] h-[19rem] desktop:w-[22rem] desktop:h-[22rem] object-contain" viewBox="0 0 640 640" xmlns="http://www.w3.org/2000/svg">
...
<style lang="less">
	...
	.footer {
		.fluid-space-clamp(padding-top, 65rem, 92rem);
		.fluid-space-clamp(padding-bottom, 42rem, 86rem);
		.fluid-space-clamp(padding-left, 39rem, 80rem);
		.fluid-space-clamp(padding-right, 39rem, 261rem);
		.fluid-space-clamp(row-gap, 32rem, 50rem);
	}

	.footer__content {
		.fluid-space-clamp(row-gap, 32rem, 36rem);
	}
</style>